...
import { PiEyeDuotone, PiInvoiceBold, PiInvoiceDuotone, PiTruckFill } from "react-icons/pi";
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            url: "/dashboard/reports/playbackReport",
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: " اماكن الحاويات",
            url: "/dashboard/binsLocations",
            icon: NotepadText,

            items: [],
          },
          {
            title: " مسارات المركبات",
            url: "/dashboard/reports/monthly",
            icon: NotepadText,
